# -*- coding: utf-8 -*-
"""
Created on Mon May 27 18:20:10 2019
...
import torch
import math
from models.BoxResNet import boxresnet50

class BoxPSP_head(nn.Module):
    
    def __init__(self, in_channels):
        
        super(BoxPSP_head, self).__init__()
...
class BoxResnet50_8s_psp(nn.Module):
    
    def __init__(self, num_classes=1000):
        
        super(BoxResnet50_8s_psp, self).__init__()
        
        # Load the pretrained weights, remove avg pool
        # layer and get the output stride of 16
        resnet50_8s = boxresnet50()
        
        self.psp_head = BoxPSP_head(resnet50_8s.inplanes)
